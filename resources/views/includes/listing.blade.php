                            ...
                            <div class="article-details">
                                ...
                                <div class="article-user">
                                    ...
                                    <div class="article-user-details">
                                        ...
                                        <div class="text-job"><a href="{{ route('albums.show', [$photo->album->slug]) }}">{{  $photo->album->title  }}</a> {{ $photo->album->photos->count() }} {{ Str::plural('photo', $photo->album->photos->count()) }}</div>
